...
from src.indexing.indices import get_indices
from src.random import set_seeds
from src.io import read_json, save_json, merge_dicts
from src.data.preprocessing import draw_strat_sample
...
class DataSet:
    ...
    def index_split(self,
        ...
        self.splits.update({split_name: {'data_idx_train': data_idx_train,
