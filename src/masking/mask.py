...
def safe_mask(mask, fn: Callable, operand: jnp.ndarray, placeholder: int = 0, intermediate_placeholder = 0) -> jnp.ndarray:
    """
...
def safe_mask_special(mask_op, mask_fn, fn: Callable, operand: jnp.ndarray, placeholder: int = 0) -> jnp.ndarray:
    """
